---
title: "安全日报 2026-06-10"
date: 2026-06-10 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
> 🔥 今日封面：LiteLLM漏洞（CVE-2026-42271）遭野外利用，可链式触发未授权远程代码执行
> 📊 分类统计：AI安全(15) | 数据安全(5) | 工控安全(3) | 传统安全(10) | 总计 33 条

---

### 🔐 AI安全

- **[LiteLLM漏洞（CVE-2026-42271）遭野外利用，可链式触发未授权远程代码执行](https://www.freebuf.com/articles/ai-security/485197.html)**
  - LiteLLM高危漏洞遭野外利用，可未授权远程执行代码！

- **[AI野蛮生长，Fortinet如何让安全不再“盲盒”？](https://www.freebuf.com/fevents/485149.html)**
  - 5月28日，Fortinet Accelerate 2026亚太区巡展上海站在上海雅居乐万豪侯爵酒店落下帷幕。

- **[Mythos Preview可在数小时内将N-day漏洞武器化](https://www.freebuf.com/articles/ai-security/485237.html)**
  - AI武器化N-day漏洞，补丁发布即遭攻击，响应窗口缩至小时级！

- **[AI蠕虫原型实验警示：攻击者无需Mythos即可接管企业网络](https://www.freebuf.com/articles/ai-security/485238.html)**
  - AI蠕虫可劫持企业网络，开源模型+漏洞组合攻击威胁升级！

- **[前端转AI，第一个要改的不是技术栈，是脑子](https://www.freebuf.com/news/485011.html)**
  - ​前言作为一个写了 5 年 Vue + React 的前端，我用 Python + LangGraph 做了一个企业级 AIOps 排障 Agent。过程中最大的感悟是：真正难的不是调大模型，而是让大模型少干活。这篇文章讲什么我不会从头教你代码怎么写，因为这个年代工程思维才是价值。我要分享的是一个前端工程师做 AI Agent 项目的完整心路历程——从"LLM 是万能的"到"LLM 只在刀刃上用"

- **[OWASP 发布 AI 安全报告 为安全团队提供新型防御工具](https://www.freebuf.com/articles/ai-security/485062.html)**
  - "OWASP警告：自主AI打破安全边界，企业需紧急统一治理！"

- **[大模型代码审查的技术演进：架构、工程范式与落地方案](https://www.freebuf.com/articles/ai-security/484964.html)**
  - 本文梳理基于大语言模型（LLM）的智能体在代码审查中的技术演进。

- **[Meta AI账户恢复工具漏洞致2万+ Instagram账号遭入侵](https://www.freebuf.com/articles/database/485055.html)**
  - Meta AI工具漏洞致2万+ Instagram账户遭劫持，暴露6周才修复！

- **[为何多数企业安全团队无法通过军事级战备测试](https://www.freebuf.com/articles/es/485031.html)**
  - 企业安全团队需军事化实战演练，否则难敌AI时代网络攻击。
...
- **[Apache HTTP Server 2.4.68 发布：修复释放后重用、DoS、XSS 及缓冲区溢出漏洞](https://www.freebuf.com/articles/web/485176.html)**
  - Apache HTTP Server 2.4.68紧急修复13项高危漏洞，含UAF、XSS及DoS攻击风险！

- **[单字符Linux内核漏洞可本地提权至root，漏洞利用代码已公开](https://www.freebuf.com/articles/network/485113.html)**
  - 单字符Linux内核漏洞可本地提权至root，利用代码已公开！

- **[CVE-2025-57819 利用与 Incron 提权链](https://www.freebuf.com/articles/vuls/485038.html)**
  - 练习

- **[FreeBuf早报 \| 美政府用Mythos模型开展网络攻击；Hugging Face漏洞致远程代码执行攻击](https://www.freebuf.com/news/485036.html)**
  - 美政府用Mythos模型开展网络攻击；Hugging Face漏洞致远程代码执行攻击

- **[Vibe Coding 风险分析与安全实践](https://www.freebuf.com/articles/ai-security/484965.html)**
  - 这一模式将传统本地 IDE 中的编码、测试、构建、部署全链路上移至云端平台，平台因此成为攻击面的核心承载者。

- **[UNC3753攻击升级：从语音钓鱼到入侵美国律所与金融机构办公室](https://www.freebuf.com/articles/es/485056.html)**
  - UNC3753从电话诈骗升级至物理入侵，窃取美国律所金融数据！

- **[Instagram漏洞曝光扎克伯格及其他用户联系方式](https://www.freebuf.com/articles/database/485060.html)**
  - Instagram漏洞泄露扎克伯格等用户隐私，Meta安全再遭质疑！

- **[高管邮箱窃密：一起针对金融业的定向间谍行动](https://www.freebuf.com/articles/database/485034.html)**
  - 金融高管邮箱遭5个月隐秘窃密，攻击者利用云服务完美伪装数据外泄！

- **[VMware 多个存储型 XSS 漏洞允许攻击者注入恶意脚本](https://www.freebuf.com/articles/web/485064.html)**
  - VMware存储型XSS漏洞可让攻击者以管理员身份执行恶意操作，需紧急修复！

- **[无声劫持：蓝牙音箱成为攻击者的隐形键盘，15米内接管你的电脑](https://www.freebuf.com/articles/485120.html)**
  - Sound Blaster Katana V2X音箱存在严重蓝牙漏洞，可被远程控制并窃听，厂商消极应对引发安全危机。
