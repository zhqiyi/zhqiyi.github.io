---
title: "安全日报 2026-06-04"
date: 2026-06-04 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
- **[Aircrack-ng 简介和使用](https://www.freebuf.com/articles/sectool/484292.html)**
  - Aircrack-ng包含一套全面的工具，旨在评估 WiFi 网络安全。在着手分析或利用无线网络之前，必须先了解这些工具的基本功能。

- **[特朗普签署网络安全专项行政令](https://www.freebuf.com/articles/ai-security/484234.html)**
  - 特朗普重启AI网络安全令，强制联邦部署AI防御，拒设审批阻碍创新。

- **[FreeBuf早报 \| SpaceX工程师借AI发现存在19年的Linux漏洞；黑客利用Meta AI客服劫持Ins账号](https://www.freebuf.com/news/484111.html)**
  - SpaceX工程师借AI揪出19年Linux漏洞；黑客借Meta AI劫持Ins账号

- **[Anthropic扩大Project Glasswing项目范围 向150家新机构开放Claude Mythos预览版](https://www.freebuf.com/articles/ai-security/484199.html)**
  - Anthropic扩大Claude Mythos漏洞检测范围，150家关基机构备战AI网络攻防战。

- **[黑客利用 Meta AI 客服机器人重置密码并劫持 Instagram 账号](https://www.freebuf.com/articles/ai-security/484061.html)**
  - Meta AI客服漏洞致高价值Instagram账号遭劫持，双重认证被绕过！
...
- **[FreeBuf早报 \| Codex UI工具暗中窃取OpenAI用户令牌；Notepad++ 漏洞利用代码公开](https://www.freebuf.com/news/483952.html)**
  - Codex UI工具暗中窃取OpenAI用户令牌；Notepad++ 漏洞利用代码公开

- **[护网复盘2026：AI如何改变攻防规则（综述篇）](https://www.freebuf.com/articles/web/483916.html)**
  - AI重塑护网攻防全局，红队攻击门槛骤降、蓝队防御范式迭代，传统安全规则与人防技防边界彻底重构
...
- **[漏洞挖掘：注入类](https://www.freebuf.com/articles/web/484286.html)**
  - 第一步：找到所有可能和数据库交互的输入点

- **[Windows搜索URI处理程序漏洞导致NTLMv2哈希泄露至攻击者控制服务器](https://www.freebuf.com/articles/system/484359.html)**
  - Windows搜索漏洞致NTLMv2哈希泄露，微软未修复！

- **[HTTP/2 炸弹攻击——新型远程拒绝服务漏洞影响 nginx、Apache、IIS、Envoy 和 Cloudflare Pingora](https://www.freebuf.com/articles/web/484342.html)**
  - HTTP/2炸弹攻击可秒级耗尽服务器内存，影响主流Web服务！

- **[Wi-Fi渗透测试基础知识](https://www.freebuf.com/articles/network/484196.html)**
  - 本文将详细讲解WiFi渗透测试的基础常识、主流WiFi认证协议，以及核心的四大检测维度，帮助零基础及入门学习者快速掌握WiFi安全检测的核心逻辑。

- **[详细指南：使用CDN后DNS解析配置的详细步骤和常见问题](https://www.freebuf.com/articles/network/484103.html)**
  - 很多业务接入CDN后出现访问异常、回源失败、节点调度错乱等问题，根源大多是DNS解析配置不规范。本文将结合实际运维场景，全面讲解使用CDN时完整的DNS解析配置方案以及故障排查要点。一、CDN场景下DNS解析的核心工作原理未接入CDN时，用户访问网站域名，DNS会直接将域名解析为源站服务器公网IP，所有请求全部直达源站，源站承载全部访问、带宽与缓存压力。接入CDN后，用户发起域名解析请求，本地DN

- **[收到“违纪通报”“裁员名单及补偿方案”？别点！可能是银狐病毒在钓鱼](https://www.freebuf.com/news/484098.html)**
  - 近期，国家计算机病毒应急处理中心发布预警报告：依托国家计算机病毒协同分析平台，捕获了多个文件名包含“内部调查结果”“违纪名单”“违纪通报信息”“裁员补偿”等词汇的恶意程序。这些文件表面上伪装成文件夹、快捷方式或PDF文档，实则均为针对Windows平台的远程控制木马病毒，且是“银狐”家族的最新变种。一旦用户不慎运行，攻击者便可远程控制电脑、窃取信息，甚至利用被控设备实施电信诈骗。作为长期活跃于网络

- **[Python恶意软件SolyxImmortal窃取浏览器密码、Cookie、文件及键盘记录](https://www.freebuf.com/articles/database/484191.html)**
  - Python恶意软件SolyxImmortal窃取密码、Cookie及键盘记录，专盯土耳其用户！

- **[安卓0Day漏洞遭利用 攻击者可完全控制设备](https://www.freebuf.com/articles/system/484160.html)**
  - 安卓0day漏洞遭利用，攻击者可完全控制设备！

- **[Android 0Day漏洞现已被野外利用](https://www.freebuf.com/news/484046.html)**
  - 安卓0day漏洞正被利用，谷歌紧急修复113个漏洞，18个可致设备完全被控！
