...
> 🔥 今日封面：史上首次完全自主AI Agent网络攻击；Kimi K3 Agent发现多个Redis零日漏洞 | FreeBuf周报
...
- **[史上首次完全自主AI Agent网络攻击；Kimi K3 Agent发现多个Redis零日漏洞 \| FreeBuf周报](https://www.freebuf.com/articles/493262.html)**
  - 各位 Buffer 周末好，以下是本周「FreeBuf周报」，我们总结推荐了本周的热点资讯、一周好文，保证大家不错过本周的每一个重点！

- **[CyberStrike：AI 驱动的自动化渗透测试安全平台](https://www.freebuf.com/articles/ai-security/493291.html)**
  - 无需人类持续提示，CyberStrike将任何LLM订阅转化为自主红队操作员，自动完成侦察、漏洞利用与报告，攻击性大幅提升，仅限授权测试。
...
- **[Coldcard 硬件钱包漏洞被指与 41 分钟 7000 万美元比特币被盗有关](https://www.freebuf.com/articles/493316.html)**
  - Coldcard硬件钱包弱随机数漏洞致7000万美元比特币被盗，攻击者41分钟扫荡1196个地址。
