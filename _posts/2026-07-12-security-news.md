---
title: "安全日报 2026-07-12"
date: 2026-07-12 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
> 🔥 今日封面：ChatGPT文件下载流程漏洞可被利用访问系统文件；新型攻击可远程劫持AI编程Agent执行恶意代码 | FreeBuf周报
...
- **[ChatGPT文件下载流程漏洞可被利用访问系统文件；新型攻击可远程劫持AI编程Agent执行恶意代码 \| FreeBuf周报](https://www.freebuf.com/articles/489743.html)**
  - 各位 Buffer 周末好，以下是本周「FreeBuf周报」，我们总结推荐了本周的热点资讯、一周好文，保证大家不错过本周的每一个重点！

- **[一文看懂 GPT-5.6 系列：Cyber 能力和安全护栏究竟怎么样？](https://www.freebuf.com/articles/489708.html)**
  - GPT-5.6在ExploitBench上从47.9%跃升至73.5%，是自动挖洞的开始还是防守者的杠杆？OpenAI称其最强cyber model，但护栏仍有漏网。

- **[Claude Code、Codex CLI 等AI Coding Agent 被利用攻击实现 RCE？新型供应链攻击？](https://www.freebuf.com/news/489613.html)**
  - 未来如果越来越多开发工具默认允许 Agent 自动执行命令，这类攻击可能会越来越常见。

- **[自测会不会被 Claude Code 标记为中国用户，有人做了个网页。CheckCC 开源了！](https://www.freebuf.com/articles/489815.html)**
  - IP在美国时区却上海？CheckCC暴露环境冲突，别等封号才后悔，像诈骗窝点一样被风控！

- **[AI时代下对安全攻防演进的思考（上篇）](https://www.freebuf.com/articles/web/489585.html)**
  - AI技术正深刻改变安全攻防领域，从漏洞挖掘到防御流程，探讨AI如何重塑Web安全、Pwn与逆向工程的核心战场。

- **[AI时代下对安全攻防演进的思考（中篇）](https://www.freebuf.com/articles/web/489534.html)**
  - AI正加速Web安全基础漏洞的工业化发现，同时推动复杂业务逻辑漏洞和AI原生应用风险成为新战场。

- **[AI时代下对安全攻防演进的思考（下篇）](https://www.freebuf.com/articles/es/489533.html)**
  - AI赋能安全攻防，企业流程重写成关键，安全人员角色转向“指挥者”，行业竞争聚焦工具生态。

- **[FreeBuf早报 \| 首个一键式Android 17漏洞利用链可使攻击者完全控制手机；当Claude等AI编程工具触发安全警报](https://www.freebuf.com/news/489524.html)**
...
- **[一个 GET 权限怎么变成集群 RCE：Kubernetes RBAC nodesproxy 的授权盲区](https://www.freebuf.com/articles/vuls/489654.html)**
  - 一个 GET 权限怎么变成集群 RCE：Kubernetes RBAC nodes/proxy 的授权盲区一个 GET 权限，Kubernetes 官方说这是 working as intended，但它能给你整个集群的 RCE。2026 年 1 月 26 日，安全研究员 Graham Helton 在博客上发了一篇长文，标题很直白：Kubernetes Remote Code Execution

- **[281款免费安卓VPN应用被曝流量泄露、未加密数据和追踪](https://www.freebuf.com/articles/endpoint/489723.html)**
  - 281款免费安卓VPN应用被曝流量泄露、明文传输及隧道劫持，累计安装超24亿次，多数未满足基本安全需求。

- **[DVWA SQL 注入实操笔记（Day1）— Low  Medium  High 全级别通关](https://www.freebuf.com/articles/web/489636.html)**
  - DVWA 靶场 SQL 注入完整通关，覆盖 Low / Medium / High 三个安全级别。从闭合方式判断、Union 联合查询到 information_schema 脱库，再到 BurpSu

- **[Linux内核FUSE漏洞可致攻击者获取Root权限](https://www.freebuf.com/articles/system/489742.html)**
  - Linux内核FUSE漏洞可致本地攻击者破坏SUID二进制文件，获取root权限。

- **[新型Windows进程注入技术绕过四大主流EDR解决方案](https://www.freebuf.com/articles/489730.html)**
  - 新型进程参数投毒技术绕过四大主流EDR，利用启动参数注入shellcode，规避传统检测指标。

- **[Odyssey Stealer 再度袭击 macOS 用户，波及 100 多个国家，瞄准 300 款加密货币钱包扩展](https://www.freebuf.com/articles/endpoint/489711.html)**
  - Odyssey Stealer再度袭击macOS用户，波及100多国，瞄准300款加密货币钱包扩展，威胁严重。

- **[Microsoft 揭露 GigaWiper：一款按需实施破坏的后门](https://www.freebuf.com/articles/system/489644.html)**
  - 微软揭露GigaWiper后门：融合远程管理、多种擦除逻辑及丢弃密钥的勒索模块，实现按需破坏。

- **[Django SQL注入漏洞已在野外被积极利用](https://www.freebuf.com/articles/web/489664.html)**
  - Django高危SQL注入漏洞正在被积极利用，可导致数据库入侵，需立即修补。

- **[新 runner 没人认识：GitHub Actions self-hosted runner 冷启动盲区](https://www.freebuf.com/articles/vuls/489583.html)**
  - 新 runner 没人认识：GitHub Actions self-hosted runner 冷启动盲区聊 self-hosted runner 安全，十篇有九篇在讲横向移动。拿到一个 job 之后怎么捞 secrets、怎么顺着 OIDC token 摸到云上、怎么在 runner 里留持久化。这些当然重要，但翻了一圈之后我发现真正没人聊的是另一个东西：一台刚注册进来的 runner，谁也不认

- **[一行 header key 拆掉 CVSS 9.9 的 serverless 框架：Nuclio cron trigger 命令注入拆解（CVE-2026-52831）](https://www.freebuf.com/articles/vuls/489582.html)**
  - 两条注入路径都挖出来、持久化机制单独点出来、补丁测试用例覆盖到位，这是个完整的漏洞报告该有的样子。
