---
title: "安全日报 2026-08-09"
date: 2026-08-09 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
> 🔥 今日封面：OpenAI 为评估网络安全能力，放缓 Astra 新模型开发
...
- **[OpenAI 为评估网络安全能力，放缓 Astra 新模型开发](https://www.freebuf.com/articles/ai-security/494122.html)**
  - OpenAI因Astra模型网络安全能力逼近Critical风险，紧急放缓开发并强化安全措施。

- **[CVSS 10.0 的"错误授权"：Adobe Campaign Classic 未认证 RCE 的代码真相](https://www.freebuf.com/articles/vuls/494081.html)**
  - 这类漏洞为什么会存在，以及同类错误在 Java Web 应用里长什么样。

- **[Mythos 5与GPT-5.6-Sol突破网络测试边界；Ruby on Rails曝出严重漏洞 \| FreeBuf周报](https://www.freebuf.com/articles/494070.html)**
  - 各位 Buffer 周末好，以下是本周「FreeBuf周报」，我们总结推荐了本周的热点资讯、一周好文，保证大家不错过本周的每一个重点！

- **[木马化的 AI skills 在针对 Agent 的攻击中获得 170 万次安装 \| CSO Online](https://www.freebuf.com/articles/ai-security/494109.html)**
  - 仿冒Paperclip和Browser Use的木马化AI skills获170万安装，指示Agent安装窃密器，威胁AI供应链。

- **[Chrome 版 Claude 提示注入漏洞可窃取 Gmail 验证码，劫持 Slack、X 和 Claude.ai 账户](https://www.freebuf.com/articles/ai-security/494103.html)**
  - Chrome版Claude曝提示注入漏洞，攻击者借恶意邮件窃取Gmail验证码，可劫持Slack、X及Claude.ai账户，危害严重。
...
- **[Metabase 0Day漏洞遭在野利用，无需认证即可获得管理员权限](https://www.freebuf.com/news/494123.html)**
  - Metabase 0day漏洞遭在野利用，无需认证即可获得管理员权限，Framework客户数据泄露，CVSS满分10.0，紧急修复！
...
- **[4400余台罗克韦尔PLC暴露于互联网，供水系统面临网络攻击威胁](https://www.freebuf.com/articles/ics-articles/493963.html)**
  - 4400余台罗克韦尔PLC暴露公网，攻击者修改逻辑锁定操作员，美国水系统遭水淹，FBI联合EPA警告。
...
The post Despite federal warnings, thousands of U.S. indu
...
- **[UNC6671 语音钓鱼攻击针对个人手机以窃取 SaaS 数据](https://www.freebuf.com/news/494114.html)**
  - 标签：网络安全、企业安全  
分类：资讯

- **[Windows 内核组件提权漏洞 PoC 已公开（0day）漏洞复现和分析](https://www.freebuf.com/articles/vuls/494065.html)**
  - Windows 内核组件提权漏洞 PoC 已公开（0day）漏洞复现和分析

- **[XSS2Shell 漏洞技术分析](https://www.freebuf.com/articles/web/494115.html)**
  - WordPress曝XSS2Shell漏洞链，未认证登录页XSS可致RCE，超5亿网站受影响，速修复！

- **[Linux 内核 SCTP 漏洞潜伏 18 年，攻击者可获取宿主机完整 root 权限](https://www.freebuf.com/articles/system/494117.html)**
  - 18年潜伏！Linux内核SCTP漏洞可提权root并逃逸容器，影响多版本，管理员应立即修复。

- **[存在 18 年的 Linux SCTP 漏洞可致本地用户获取 root 权限并逃逸容器](https://www.freebuf.com/articles/system/494092.html)**
  - 存在18年的Linux SCTP漏洞可获root权限并逃逸容器，请立即更新。

- **[新 NatJack 攻击通过操纵 NAT 表劫持 TCP 会话并伪造 DNS 响应](https://www.freebuf.com/articles/494093.html)**
  - NatJack攻击操纵NAT表劫持TCP会话并伪造DNS，影响Windows/Linux，无单一补丁，需立即隔离与加密。

- **[今晚19:30直播｜跨平台操作：多安全产品协同运营的新实践](https://www.freebuf.com/articles/494018.html)**
  - 今晚19点30分，直播间等你。

- **[Zapscape（CVE-2026-64561）漏洞可致 KVM 客户机逃逸至 Linux 主机并获得 Root 权限](https://www.freebuf.com/articles/system/494100.html)**
  - 标签：企业安全、网络安全  
分类：系统安全

- **[研究人员发现 20 款路由器型号存在隐藏后门，允许远程获取 root 权限](https://www.freebuf.com/news/494072.html)**
  - 20款路由器内置隐藏后门，可远程获取root权限，无补丁，设备应视为已沦陷。

- **[DLL 劫持——如何把恶意 DLL 塞进高权限程序的加载链](https://www.freebuf.com/articles/system/493985.html)**
  - DLL作为windows提权的重量级选手，如何利用DLL劫持来提升windows权限呢
