---
title: "安全日报 2026-07-20"
date: 2026-07-20 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
> 🔥 今日封面：Hugging Face确认AI驱动入侵：攻击者使用自主Agent，防御者以AI反击
> 📊 分类统计：AI安全(15) | 数据安全(8) | 工控安全(5) | 传统安全(10) | 总计 38 条

---

### 🔐 AI安全

- **[Hugging Face确认AI驱动入侵：攻击者使用自主Agent，防御者以AI反击](https://www.freebuf.com/articles/ai-security/491069.html)**
  - Hugging Face证实遭AI Agent自主入侵，窃取云与集群凭据并横向移动；防御方用LLM法医分析反击，强调必须准备自托管AI模型以应对机器速度攻击。

- **[白宫推出AI驱动漏洞清算中心；黑客借助Gemini CLI构建实时C&C僵尸网络 \| FreeBuf周报](https://www.freebuf.com/articles/490879.html)**
  - 各位 Buffer 周末好，以下是本周「FreeBuf周报」，我们总结推荐了本周的热点资讯、一周好文，保证大家不错过本周的每一个重点！

- **[AI 赋能的WebShell 工具！Godzilla增强版，AI MCP 远程操控，内存马注入、提权，红队免杀对抗拉满](https://www.freebuf.com/articles/sectool/491068.html)**
  - GSL5是哥斯拉深度二次开发的红队后渗透与WebShell管理平台，3.1.0版新增AI驱动MCP服务及RASP绕过能力。

- **[NVIDIA 开源了 AI Agent 安全扫描器：68 种漏洞模式、17 个风险类别，安装 Skill 前先过一遍](https://www.freebuf.com/articles/491093.html)**
  - SkillSpector扫描AI Agent Skills，检测68种漏洞/17类风险，0-100评分判断能否安装。

- **[据报道，GPT-5.6 Codex 误删用户家目录文件](https://www.freebuf.com/articles/ai-security/490897.html)**
  - GPT-5.6 Codex误删用户家目录文件，数据丢失风险高，开发者须立即限制Agent权限。

- **[告别“合规幻觉”：AI时代网络安全建设的经济学逻辑](https://www.freebuf.com/articles/others-articles/490664.html)**
  - 本文跳出合规与AI算力内卷，提出“代价制衡”实战新范式。依托无特征行为建模与轻量化架构，构建攻防经济学模型，助政企重构安全ROI，实现从被动合规到主动实战威慑的战略升级。

- **[新型Agent数据注入攻击可诱导AI Agent误点或执行攻击者指令](https://www.freebuf.com/articles/ai-security/490720.html)**
  - 植入评论即可诱导AI Agent误点购买或执行攻击指令，Agent数据注入攻击正突破现有防御，紧迫性极高。
...
- **[《AI Token中转站安全性评测报告》发布｜欢迎至 WAIC 2026 斗象展区领取](https://www.freebuf.com/consult/491038.html)**
  - 大模型应用正加速迈向规模化落地，AI Token 中转站也逐渐成为连接开发者与基础模型的重要基础设施。凭借统一接口、多模型调度、成本优化等能力，中转站正在降低 AI 应用开发门槛，加速企业 AI 能力落地。与此同时，越来越多的 AI 请求、数据和 Token 在中转站汇聚流转，模型真实性、数据安全、响应完整性、账单透明度、服务稳定性等问题也成为企业关注的重点。AI Token 中转站已不仅是提升开

- **[安永（EY）披露第三方支持工单系统遭入侵，客户数据泄露](https://www.freebuf.com/articles/database/490999.html)**
  - 安永第三方IT支持平台遭入侵，客户税务信息在3月28日至4月12日期间被未授权下载。
...
- **[记一次微信小程序逆向](https://www.freebuf.com/articles/web/491096.html)**
  - 反编译小程序破解AES加密和签名，绕过防护实现重放，泄露大量学生信息接口。

- **[26年HW行情怎么样？](https://www.freebuf.com/articles/490960.html)**
  - 2026年HW行情分析：薪资腰斩、速成班泛滥、企业资金吃紧，蓝队“舒适区”被彻底打破，红队技术门槛持续拉高。

- **[Windows LegacyHive 0Day 漏洞可让黑客获取管理员权限](https://www.freebuf.com/articles/system/490977.html)**
  - Windows LegacyHive 0Day漏洞可让黑客获取管理员权限，影响所有支持的Windows版本，微软尚未修复。

- **[记一次支付金额篡改漏洞的挖掘实录](https://www.freebuf.com/articles/web/491063.html)**
  - 从客户端加密配置入手，恢复签名算法并伪造请求，最终将真实32元订单篡改为1角，突破支付完整性。

- **[多个 TP-Link 摄像头漏洞可致黑客发动中间人攻击](https://www.freebuf.com/news/490895.html)**
  - TP-Link摄像头曝高危漏洞，硬编码密钥可致中间人攻击，窃取凭据，用户需立即更新固件。

- **[流量全加密蓝队抓啥：红队 C2 从域名前置到流量伪装的隐蔽通信拆解](https://www.freebuf.com/articles/defense/490732.html)**
  - C2 隐蔽通信的攻防对抗，核心不是某一种技术的优劣，是检测范式的代际差。

- **[拿到低权限 shell 就完事了？从普通用户到 root 的权限提升全拆解](https://www.freebuf.com/articles/defense/490731.html)**
  - 权限提升是攻防对抗里最见功力的环节。

- **[一封邮件干翻整个域：红队钓鱼从情报收集到武器化的全路径拆解](https://www.freebuf.com/articles/defense/490730.html)**
  - 攻防的差距，往往不在技术，在速度。

- **[4 行 diff 没写，71 个 SOAP 操作全暴露：MantisBT CVE-2026-47156 认证绕过拆解](https://www.freebuf.com/articles/vuls/490729.html)**
  - 这种&quot;一致性缺口&quot;比单点漏洞更值得警惕，因为审计的人很难想到自家产品的同一个动作在三个入口处逻辑不一样。

- **[你的 MCP Server 验了 token 却没验 audience：跨租户访问是怎么钻进来的](https://www.freebuf.com/articles/ai-security/490728.html)**
  - 更扎心的是，这三个盲区不是 MCP 独创的新坑，是老 OAuth 时代就反复踩过的旧坑换了身新衣服，只是 MCP 把能力放大了，旧坑的代价也跟着翻了倍。
