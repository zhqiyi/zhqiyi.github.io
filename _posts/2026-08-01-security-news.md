---
title: "安全日报 2026-08-01"
date: 2026-08-01 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
> 🔥 今日封面：谷歌利用 AI Agent 发现并修复 1,072 个 Chrome 安全漏洞
...
- **[谷歌利用 AI Agent 发现并修复 1,072 个 Chrome 安全漏洞](https://www.freebuf.com/articles/ai-security/493283.html)**
  - AI Agent助谷歌发现并修复Chrome漏洞，揪出潜伏13年沙箱逃逸漏洞，月省数百小时，拦截20多漏洞入生产。

- **[2026顶级攻防实录：AI自主猎杀终端！传统杀毒彻底失效的真相](https://www.freebuf.com/articles/web/493185.html)**
  - 网络安全的本质，从来不是 “对抗已知威胁”，而是 “抵御未知风险”。

- **[DeepSeek 驱动的 Hermes Agent 对暴露服务器发起自主网络攻击](https://www.freebuf.com/articles/ai-security/493260.html)**
  - AI驱动的Hermes Agent借助DeepSeek自主扫描并攻击暴露服务器，已致数据窃取和命令执行，凸显AI网络攻击的紧迫威胁。

- **[Anthropic 确认 Claude 突破测试环境，入侵 3 家组织](https://www.freebuf.com/articles/ai-security/493211.html)**
  - Anthropic确认Claude在评估中突破隔离测试环境，入侵3家真实组织，窃取凭据并访问生产数据库，即便发现是真实系统仍继续攻击。
...
- **[拆开OpenAI Codex Security：13个开源Security Skills如何组成一条可审计的AI代码安全流水线](https://www.freebuf.com/articles/ai-security/493047.html)**
  - 摘要：OpenAI 开源的 openai/codex-security并不是一组传统 SAST 规则，也不是一个可以完全离线部署的“安全大模型”。它开源的是一套 CLI、TypeScript SDK、
...
- **[Windows 提权实战：少了那对引号，C:Program就成了攻击者的提权跳板](https://www.freebuf.com/articles/system/493199.html)**
  - windows提权，居然利用windows空格原理也能提权

- **[PHP 修复三个漏洞：SQL 注入、内存损坏与服务器崩溃](https://www.freebuf.com/articles/493223.html)**
  - PHP紧急修复三漏洞：PostgreSQL扩展可致SQL注入，BCMath存内存损坏风险，恶意Phar可致服务器崩溃，请尽快升级！

- **[新型后门让黑客能够记录键盘输入、窃取密码并控制政府计算机](https://www.freebuf.com/articles/ics-articles/493245.html)**
  - 中亚政府网络遭两款定制后门攻击，可记录键盘输入、窃取密码并远程控制计算机，影响多国政府机构。

- **[vlunhub-lampiao靶机测试报告](https://www.freebuf.com/articles/system/493155.html)**
  - 该靶机的cms管理系统drupal有历史漏洞未打补丁，可以直接利用exp完成getshell，然后查看内核版本进一步利用系统漏洞(脏牛漏洞)提权。

- **[漏洞概述：Word 文档隐藏指令可被 Copilot 复制至新文件](https://www.freebuf.com/articles/ai-security/493142.html)**
  - Word文档隐藏指令可被Copilot复制至新文件，篡改数字且漏洞仍可利用，存在持续风险。
...
- **[FreeBuf早报 \| CISA 发布六步蓝图，指导基础设施在网络攻击中实现隔离；Microsoft Word Copilot 漏洞](https://www.freebuf.com/news/493121.html)**
  - CISA等发布六步隔离蓝图，强调关键系统必须构建物理隔离点，将运营商服务视为“不可信且可能具有敌意”，以遏制攻击。

- **[ROP攻击：技术起源与编写实践](https://www.freebuf.com/articles/system/493054.html)**
  - 本文详解了ROP高级内存攻击技术的起源、编写实践及防范策略。

- **[近四分之一漏洞在CVE发布前已被利用：攻击者利用窗口远超防御者](https://www.freebuf.com/news/493152.html)**
  - 近四分之一漏洞在CVE发布前已被利用，攻击者利用窗口远超防御者，CMS与网络边缘设备成主要目标。
