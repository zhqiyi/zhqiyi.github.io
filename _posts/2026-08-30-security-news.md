---
title: "安全日报 2026-08-30"
date: 2026-08-30 07:30:00 +0800
categories: 安全
tags: [安全, 网络安全, 行业, 日报]
...
> 🔥 今日封面：700个AI Agent突破隔离后秘密协调攻击Hugging Face
> 📊 分类统计：AI安全(15) | 数据安全(9) | 工控安全(5) | 传统安全(10) | 总计 39 条

---

### 🔐 AI安全

- **[700个AI Agent突破隔离后秘密协调攻击Hugging Face](https://www.freebuf.com/articles/ai-security/497858.html)**
  - 700个AI Agent突破隔离秘密协调，利用包仓库作留言板，对Hugging Face发动攻击并实现远程代码执行。

- **[ZhiShi Harness 是怎么来的：从一段提示词到一台 harness](https://www.freebuf.com/articles/sectool/497759.html)**
  - ZhiShi，安全研究领域的 agent harness

- **[网安行业大洗牌：不会用 AI 防守的先死](https://www.freebuf.com/articles/497726.html)**
  - 这份报告里的每个判断，都来自我们对国内外上百份一手资料的调研——从前沿实验室的技术文档、各国监管机构的指南原文，到一起起真实事件的完整复盘。

- **[用 AI 重构攻击链：2026 红队智能化作战方法论与实战度量](https://www.freebuf.com/articles/ai-security/497671.html)**
  - 本文从红队视角梳理如何以大模型/Agent重构侦察→利用→社工→C2杀伤链，结合2026在野数据与MITRE ATLAS映射，给出方法学骨架与蓝队检测要点。

- **[Claude Code Opus 5 自动模式遭提示注入劫持，被用于执行恶意代码](https://www.freebuf.com/articles/ai-security/497784.html)**
  - 标签：Web安全、网络安全
分类：AI安全

- **[OpenAI 称奖励黑客行为驱使 AI 代理利用 0Day 漏洞并入侵 Hugging Face](https://www.freebuf.com/articles/ai-security/497652.html)**
  - OpenAI披露奖励黑客行为驱使AI代理利用0Day漏洞入侵Hugging Face并攻陷内部基础设施，堪称失控“警示枪”。
...
- **[曼彻斯特机场集团确认客户数据遭窃取](https://www.freebuf.com/news/497854.html)**
  - 柏林遭黑客窃取5.79TB数据，市长称“柏林州正在遭受勒索”拒付赎金；曼彻斯特机场也确认客户数据泄露。
...
- **[100 余家科技与安全组织呼吁全球加强网络防御，应对 AI 攻击浪潮](https://www.freebuf.com/articles/ai-security/497796.html)**
  - 100 余家科技、网络安全和金融服务组织联合 OpenAI 发布公开信，呼吁在人工智能模型攻击与防护数字系统的能力日益增强的背景下，推动全球网络防御力量的大幅提升。
这份于周四发布的声明题为《关于网络防御集体行动的呼吁》，警告称，未来数月内，由 AI 赋能的网络攻击将变得更加普遍且更具复杂性，医院、水处理厂以及支撑互联网运行的基础设施都将面临风险。
加入该倡议的组织包括 Anthropic、Go
...
- **[攻击者可通过蓝牙完全控制 Unitree G1 人形机器人](https://www.freebuf.com/articles/endpoint/497860.html)**
  - 标签：无线安全、终端安全  
分类：终端安全

- **[NVIDIA收购Hugging Face，估值或超 130 亿美元；“豺狼行动IV”逮捕58人\| FreeBuf周报](https://www.freebuf.com/articles/497765.html)**
  - 各位 Buffer 周末好，以下是本周「FreeBuf周报」，我们总结推荐了本周的热点资讯、一周好文，保证大家不错过本周的每一个重点！

- **[CVE-2026-8452：一串空格分隔的命名空间，把 NetScaler 打回三年前](https://www.freebuf.com/articles/vuls/497757.html)**
  - 这些二十年前就该死透的属性凑在一起，撑起了 NetScaler 三年来第一个公开的预认证 RCE。

- **[宇树G1 EDU人形机器人漏洞可致root级远程代码执行，漏洞经由蓝牙触发](https://www.freebuf.com/articles/system/497800.html)**
  - Unitree G1 EDU被曝两处root级RCE：chat_go与蓝牙路径可攻破，云授权缺陷已修复。

- **[IDA Pro进阶之MCP学习](https://www.freebuf.com/articles/sectool/497719.html)**
  - 实验环境：Window 10 IDA Pro 9.3.260213 Python 3.11 Git-2.55.0.3 Trae 3.3.78一、MCP是什么（Model Context Protoco

- **[内部威胁防护：人员异动场景下，离职风险分析的落地与避坑实践](https://www.freebuf.com/articles/database/497688.html)**
  - 安全人员要理性看待这类能力：它提供的是可供研判的行为线索，最终风险判断，依旧离不开人的业务经验介入。

- **[数字资产安全管控：从资产测绘到风险收敛的落地实践](https://www.freebuf.com/articles/es/497684.html)**
  - 数字资产安全管控的终点，不是一套平台的上线，而是让"每一个数字资产都有人负责、每一份风险都走到闭环"成为组织的默认行为。这条路没有终点，但每一步收敛都是实实在在的收益。

- **[一个头像卖了整个黑客组织：Ruben Thomson溯源实录](https://www.freebuf.com/news/497812.html)**
  - 你以为换个马甲、改个ID就能逍遥法外？一张独特猫头像成突破口，安全研究员跨平台溯源，最终让攻击者落网。

- **[VulnCheck 接管 ZBT 路由器后门](https://www.freebuf.com/news/497692.html)**
  - ZBT路由器固件后门曝光：一个数据包即可远程获取root权限，设备大量部署，应视为已遭入侵。

- **[顶级C2免杀技术介绍](https://www.freebuf.com/articles/endpoint/497695.html)**
  - 顶级C2 Nighthawk 1.0发布，号称比Cobalt Strike更硬核，披露绕过CET的调用栈伪装等免杀技术。
